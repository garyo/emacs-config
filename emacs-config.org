...
[https://github.com/hrs/dotfiles/blob/main/emacs/dot-emacs.d/configuration.org][Harry R. Schwarz's config]
...
(use-package metal-mode
  :straight (:host github
                   ...
                   :branch "master")
  :config
  ;; quick & dirty hack: don't reformat metal-mode buffers with clang-format
  ;; metal mode is derived from C mode and we set up before-save-hook there.
  (add-hook 'metal-mode-hook (lambda () (setq before-save-hook nil)))
  )
#+end_src
